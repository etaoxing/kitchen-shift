...
CAMERAS = {
    ...
    6: dict(distance=2.9, lookat=[-0.05, 0.5, 2.0], azimuth=90, elevation=-50),
    7: dict(
...
FRANKA_INIT_QPOS = np.array([1.48388023e-01, -1.76848573e+00,  1.84390296e+00, -2.47685760e+00,
                             2.60252026e-01,  7.12533105e-01,  1.59515394e+00,  4.79267505e-02,
...
INIT_QPOS = {
    ...
    'bottomknob': np.array([3.12877220e-05, -4.51199853e-05]),
    'topknob': np.array([6.28065475e-05, 4.04984708e-05]),
    'bottomknobr': np.array([-2.66279850e-04, -5.18043486e-05]),
    'topknobr': np.array([-3.90842156e-06, -4.22629655e-05]),
    'switch': np.array([0.00046273, -0.00022691]),
    'slide': np.array([-0.0004655]),
    'hinge': np.array([-0.00644129, -0.00177048]),
    'microwave': np.array([0.0010801]),
    'kettle': np.array(
        [
            -2.69397440e-01,
            3.50383255e-01,
