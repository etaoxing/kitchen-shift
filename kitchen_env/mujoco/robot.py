...
class Robot:
    ...
    def ctrl_velocity_limits_posact(self, ctrl_position, step_duration):
        ctrl_desired_vel = (ctrl_position - self.last_qpos[: self.n_jnt]) / step_duration
        ...
        ctrl_feasible_position = self.last_qpos[: self.n_jnt] + ctrl_feasible_vel * step_duration
